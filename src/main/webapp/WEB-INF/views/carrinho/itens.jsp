...
<tags:pageTamplate titulo="Livros de Java, SOA, Android, iPhone, Ruby on Rails e muito mais">
                ...
                <c:forEach items="${carrinhoCompras.itens }" var="item">
                    <tr>
                        ...
                        <td class="quantity-input-cell">
                            <input type="number" min="0" readonly="readonly" id="quantidade"
                                   name="${carrinhoCompras.getQuantidade(item) }" value="1"/>
                        </td>
